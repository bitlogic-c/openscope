...
export default class RadarTargetCollection extends BaseCollection {
    ...
    constructor(theme) {
        ...
        /**
         * Collection of stripview [cid, aircraftId] tuples
    ...
    */
    ...
    findRadarTargetModelForAircraftReference(aircraftReference) {
        // The ID of the aircraft, from the cid
        const aircraftId = this._stripviews[aircraftReference];
    ...
    */
    ...
    _addStripViewLink = (stripView) => {
        this._stripviews[stripView.cid] = stripView.aircraftId;
    }
